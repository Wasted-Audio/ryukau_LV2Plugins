...
class SoftClipperUI : public PluginUI {
protected:
...
public:
  SoftClipperUI() : PluginUI(defaultWidth, defaultHeight)
  {
    ...
    auto orderIntLabel = addLabel(left1, top0, knobX, "Order Integer");
    ...
    auto orderFracLabel = addLabel(left1, top0 + labelY, knobX, "Order Fraction");
    ...
    addSplashScreen(
      ...
      defaultWidth - 30.0f, defaultHeight - 30.0f, "SoftClipper");
  }
};
