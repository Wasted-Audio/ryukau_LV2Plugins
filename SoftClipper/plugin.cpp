...
class SoftClipper : public Plugin {
public:
...
protected:
  /* Information */
  const char *getLabel() const override { return "SoftClipper"; }
  const char *getDescription() const override { return "A soft clipper."; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SoftClipper)
};

Plugin *createPlugin() { return new SoftClipper(); }
