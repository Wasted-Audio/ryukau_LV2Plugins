...
struct FastMathApproximations {
  ...
  */
  template<typename FloatType> static FloatType cosh(FloatType x) noexcept
  {
    auto x2 = x * x;
  ...
  */
  ...
  /** Provides a fast approximation of the function sinh(x) using a Pade approximant
      ...
      advised to use input values only between -5 and +5 for limiting the error.
  */
  template<typename FloatType> static FloatType sinh(FloatType x) noexcept
  {
    auto x2 = x * x;
    auto numerator
  ...
  */
  ...
  /** Provides a fast approximation of the function tanh(x) using a Pade approximant
      ...
      advised to use input values only between -5 and +5 for limiting the error.
  */
  template<typename FloatType> static FloatType tanh(FloatType x) noexcept
  {
    auto x2 = x * x;
  ...
  */
  template<typename FloatType> static FloatType cos(FloatType x) noexcept
  {
    auto x2 = x * x;
    auto numerator = -(-39251520 + x2 * (18471600 + x2 * (-1075032 + 14615 * x2)));
  ...
  */
  ...
  /** Provides a fast approximation of the function sin(x) using a Pade approximant
      ...
      advised to use input values only between -pi and +pi for limiting the error.
  */
  template<typename FloatType> static FloatType sin(FloatType x) noexcept
  {
    auto x2 = x * x;
    auto numerator
      = -x * (-11511339840 + x2 * (1640635920 + x2 * (-52785432 + x2 * 479249)));
  ...
  */
  template<typename FloatType> static FloatType tan(FloatType x) noexcept
  {
    auto x2 = x * x;
    auto numerator = x * (-135135 + x2 * (17325 + x2 * (-378 + x2)));
    auto denominator = -135135 + x2 * (62370 + x2 * (-3150 + 28 * x2));
  ...
  */
  template<typename FloatType> static FloatType exp(FloatType x) noexcept
  {
  ...
  */
  template<typename FloatType> static FloatType logNPlusOne(FloatType x) noexcept
  {
