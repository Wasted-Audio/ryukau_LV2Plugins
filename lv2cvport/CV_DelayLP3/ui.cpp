...
class CV_DelayLP3UI : public PluginUI {
protected:
...
public:
  CV_DelayLP3UI() : PluginUI(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, "CV_DelayLP3");
    ...
    addLabel(left0, top0 + 3 * labelY, knobX, "Lowpass [Hz]", labelAlign);
    addTextKnob(
      left1, top0 + 3 * labelY, knobX, colorBlue, ID::lowpassHz, Scales::cutoff, false,
      5);

    addLabel(left0, top0 + 4 * labelY, knobX, "Resonance", labelAlign);
    addTextKnob(
      left1, top0 + 4 * labelY, knobX, colorBlue, ID::resonance, Scales::resonance, false,
      5);

    addLabel(left0, top0 + 5 * labelY, knobX, "Highpass [Hz]", labelAlign);
    addTextKnob(
      left1, top0 + 5 * labelY, knobX, colorBlue, ID::highpassHz, Scales::cutoff, false,
      5);
  }
};
