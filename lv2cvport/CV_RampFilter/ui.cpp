...
class CV_RampFilterUI : public PluginUI {
protected:
...
public:
  CV_RampFilterUI() : PluginUI(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, "CV_RampFilter");
    ...
    addLabel(left0, top0 + 4 * labelY, knobX, "RampLimit", labelAlign);
    addTextKnob(
      left1, top0 + 4 * labelY, knobX, colorBlue, ID::rampLimit, Scales::rampLimit, false,
      6);

    addLabel(left0, top0 + 5 * labelY, knobX, "Bias", labelAlign);
    addTextKnob(
      left1, top0 + 5 * labelY, knobX, colorRed, ID::bias, Scales::bias, false, 6);

    addLabel(left0, top0 + 6 * labelY, knobX, "BiasTuning", labelAlign);
    addTextKnob(
      left1, top0 + 6 * labelY, knobX, colorRed, ID::biasTuning, Scales::biasTuning,
      false, 6);
