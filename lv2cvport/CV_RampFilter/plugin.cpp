...
class CV_RampFilter : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_RampFilter() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_RampFilter"; }
  const char *getDescription() const override
  {
    return "Ramp decimator combined with resonance filter.";
  }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_RampFilter)
};

Plugin *createPlugin() { return new CV_RampFilter(); }
