...
class CV_PTRTrapezoid : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_PTRTrapezoid() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_PTRTrapezoid"; }
  const char *getDescription() const override
  {
    return "Monophonic PTR trapezoid oscillator. Internally using double "
           "precision.";
  }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_PTRTrapezoid)
};

Plugin *createPlugin() { return new CV_PTRTrapezoid(); }
