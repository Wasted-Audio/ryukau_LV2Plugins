...
class CV_ExpPolyADEnvelopeUI : public PluginUI {
protected:
...
public:
  CV_ExpPolyADEnvelopeUI() : PluginUI(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, "CV_ExpPolyADEnvelope");
    ...
    addLabel(left0, top0 + 3 * labelY, knobX, "Curve", labelAlign);
    addTextKnob(
      left1, top0 + 3 * labelY, knobX, colorBlue, ID::curve, Scales::curve, false, 4);
  }
};
