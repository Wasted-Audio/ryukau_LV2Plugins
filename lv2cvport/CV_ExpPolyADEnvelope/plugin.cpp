...
class CV_ExpPolyADEnvelope : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_ExpPolyADEnvelope() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_ExpPolyADEnvelope"; }
  const char *getDescription() const override
  {
    return "Exponential polynomial AD envelope.";
  }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_ExpPolyADEnvelope)
};

Plugin *createPlugin() { return new CV_ExpPolyADEnvelope(); }
