...
class CV_HoldFilter : public Plugin {
public:
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_HoldFilter"; }
  const char *getDescription() const override
  {
    return "Step decimator combined with resonance filter. Using PolyBLEP residual to "
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_HoldFilter)
};

Plugin *createPlugin() { return new CV_HoldFilter(); }
