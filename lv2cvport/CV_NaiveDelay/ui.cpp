...
class CV_NaiveDelayUI : public PluginUIBase {
protected:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_NaiveDelayUI)

public:
  CV_NaiveDelayUI() : PluginUIBase(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, labelHeight, midTextSize, "CV_NaiveDelay");
...
UI *createUI() { return new CV_NaiveDelayUI(); }
