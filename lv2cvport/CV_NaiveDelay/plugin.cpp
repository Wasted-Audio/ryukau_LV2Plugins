...
class CV_NaiveDelay : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_NaiveDelay() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_NaiveDelay"; }
  const char *getDescription() const override { return "Naive feedback delay."; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_NaiveDelay)
};

Plugin *createPlugin() { return new CV_NaiveDelay(); }
