...
class CV_3PoleLPUI : public PluginUI {
protected:
...
public:
  CV_3PoleLPUI() : PluginUI(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, "CV_3PoleLP");
    ...
    addLabel(left0, top0 + 4 * labelY, knobX, "DC Block", labelAlign);
    addTextKnob(
      left1, top0 + 4 * labelY, knobX, colorBlue, ID::dcBlock, Scales::dcBlock, false, 6);

    addLabel(left0, top0 + 5 * labelY, knobX, "Highpass", labelAlign);
    addTextKnob(
      left1, top0 + 5 * labelY, knobX, colorBlue, ID::highpass, Scales::highpass, false,
      6);

    addCheckbox(left0, top0 + 6 * labelY, knobX, "UniformPeak", ID::uniformPeak);
    addCheckbox(left0, top0 + 7 * labelY, knobX, "UniformGain", ID::uniformGain);
  }
};
