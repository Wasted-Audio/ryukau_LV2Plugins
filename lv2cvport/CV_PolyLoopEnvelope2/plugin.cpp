...
class CV_PolyLoopEnvelope2 : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_PolyLoopEnvelope2() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_PolyLoopEnvelope2"; }
  const char *getDescription() const override
  {
    return "Polynomial curve envelope with 2 sections for loop.";
  }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_PolyLoopEnvelope2)
};

Plugin *createPlugin() { return new CV_PolyLoopEnvelope2(); }
