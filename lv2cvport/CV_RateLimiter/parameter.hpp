...
struct Scales {
  static SomeDSP::LogScale<double> slewRate;
};
...
struct GlobalParameter : public ParameterInterface {
  ...
  GlobalParameter()
  {
    ...
    value[ID::risingSlewRate] = std::make_unique<LogValue>(
      Scales::slewRate.invmap(16.0), Scales::slewRate, "risingSlewRate",
      kParameterIsAutomable | kParameterIsLogarithmic);
    value[ID::fallingSlewRate] = std::make_unique<LogValue>(
      Scales::slewRate.invmap(16.0), Scales::slewRate, "fallingSlewRate",
      kParameterIsAutomable | kParameterIsLogarithmic);
  }
