...
class CV_PolyLoopEnvelope : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_PolyLoopEnvelope() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_PolyLoopEnvelope"; }
  const char *getDescription() const override
  {
    return "Polynomial curve envelope with 8 sections for loop.";
  }
  ...
  void initAudioPort(bool input, uint32_t index, AudioPort &port)
  {
    ...
    } else if (input && index == Input::inDecay4) {
      port.hints = kAudioPortIsCV;
      port.name = String("Decay4");
      port.symbol = String("cv_decay4");
    } else if (input && index == Input::inDecay5) {
      port.hints = kAudioPortIsCV;
      port.name = String("Decay5");
      port.symbol = String("cv_decay5");
    } else if (input && index == Input::inDecay6) {
      port.hints = kAudioPortIsCV;
      port.name = String("Decay6");
      port.symbol = String("cv_decay6");
    } else if (input && index == Input::inDecay7) {
      port.hints = kAudioPortIsCV;
      port.name = String("Decay7");
      port.symbol = String("cv_decay7");
    }
    ...
    } else if (input && index == Input::inHold4) {
      port.hints = kAudioPortIsCV;
      port.name = String("Hold4");
      port.symbol = String("cv_hold4");
    } else if (input && index == Input::inHold5) {
      port.hints = kAudioPortIsCV;
      port.name = String("Hold5");
      port.symbol = String("cv_hold5");
    } else if (input && index == Input::inHold6) {
      port.hints = kAudioPortIsCV;
      port.name = String("Hold6");
      port.symbol = String("cv_hold6");
    } else if (input && index == Input::inHold7) {
      port.hints = kAudioPortIsCV;
      port.name = String("Hold7");
      port.symbol = String("cv_hold7");
    }
    ...
    } else if (input && index == Input::inLevel4) {
      port.hints = kAudioPortIsCV;
      port.name = String("Level4");
      port.symbol = String("cv_level4");
    } else if (input && index == Input::inLevel5) {
      port.hints = kAudioPortIsCV;
      port.name = String("Level5");
      port.symbol = String("cv_level5");
    } else if (input && index == Input::inLevel6) {
      port.hints = kAudioPortIsCV;
      port.name = String("Level6");
      port.symbol = String("cv_level6");
    } else if (input && index == Input::inLevel7) {
      port.hints = kAudioPortIsCV;
      port.name = String("Level7");
      port.symbol = String("cv_level7");
    }
    ...
    } else if (input && index == Input::inCurve4) {
      port.hints = kAudioPortIsCV;
      port.name = String("Curve4");
      port.symbol = String("cv_curve4");
    } else if (input && index == Input::inCurve5) {
      port.hints = kAudioPortIsCV;
      port.name = String("Curve5");
      port.symbol = String("cv_curve5");
    } else if (input && index == Input::inCurve6) {
      port.hints = kAudioPortIsCV;
      port.name = String("Curve6");
      port.symbol = String("cv_curve6");
    } else if (input && index == Input::inCurve7) {
      port.hints = kAudioPortIsCV;
      port.name = String("Curve7");
      port.symbol = String("cv_curve7");
    }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_PolyLoopEnvelope)
};

Plugin *createPlugin() { return new CV_PolyLoopEnvelope(); }
