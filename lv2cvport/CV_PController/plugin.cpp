...
class CV_PController : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_PController() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_PController"; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_PController)
};

Plugin *createPlugin() { return new CV_PController(); }
