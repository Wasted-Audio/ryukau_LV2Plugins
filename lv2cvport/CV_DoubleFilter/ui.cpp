...
class CV_DoubleFilterUI : public PluginUI {
protected:
...
public:
  CV_DoubleFilterUI() : PluginUI(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, "CV_DoubleFilter");
    ...
    addCheckbox(left0, top0 + 4 * labelY, knobX, "Highpass", ID::highpass);
    addCheckbox(left0, top0 + 5 * labelY, knobX, "Uniform Gain", ID::uniformGain);
  }
};
