...
class CV_Sin : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_Sin() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_Sin"; }
  const char *getDescription() const override
  {
    return "Monophonic sine wave oscillator";
  }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_Sin)
};

Plugin *createPlugin() { return new CV_Sin(); }
