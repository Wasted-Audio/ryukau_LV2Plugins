...
class CV_ExpADSREnvelopeUI : public PluginUI {
protected:
...
public:
  CV_ExpADSREnvelopeUI() : PluginUI(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, "CV_ExpADSREnvelope");
    ...
    addLabel(left0, top0 + 6 * labelY, knobX, "Curve", labelAlign);
    addTextKnob(
      left1, top0 + 6 * labelY, knobX, colorBlue, ID::curve, Scales::defaultScale, false,
      4);
  }
};
