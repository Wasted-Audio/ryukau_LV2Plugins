...
class CV_LinearADSREnvelopeUI : public PluginUIBase {
protected:
...
public:
  CV_LinearADSREnvelopeUI() : PluginUIBase(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(
      left0, top0, 2 * knobX, labelHeight, midTextSize, "CV_LinearADSREnvelope");
