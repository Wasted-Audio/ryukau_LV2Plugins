...
class CV_LinearADSREnvelope : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_LinearADSREnvelope() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_LinearADSREnvelope"; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_LinearADSREnvelope)
};

Plugin *createPlugin() { return new CV_LinearADSREnvelope(); }
