...
class CV_ExpLoopEnvelope : public Plugin {
public:
  // Plugin(nParameters, nPrograms, nStates).
  CV_ExpLoopEnvelope() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  /* Information */
  const char *getLabel() const override { return "CV_ExpLoopEnvelope"; }
  const char *getDescription() const override
  {
    return "Exponential curve envelope with 8 sections for loop.";
  }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CV_ExpLoopEnvelope)
};

Plugin *createPlugin() { return new CV_ExpLoopEnvelope(); }
