...
class CV_PTRSawUI : public PluginUIBase {
protected:
...
public:
  CV_PTRSawUI() : PluginUIBase(defaultWidth, defaultHeight)
  {
    ...
    addGroupLabel(left0, top0, 2 * knobX, labelHeight, midTextSize, "CV_PTRSaw");
