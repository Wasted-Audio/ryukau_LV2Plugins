...
protected:
  /* Information */
  const char *getLabel() const override { return "L3Reverb"; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(L3Reverb)
};

Plugin *createPlugin() { return new L3Reverb(); }
