...
constexpr uint8_t latticeSize = 8;
...
#define DSPCORE_CLASS(INSTRSET)                                                          \
  ...
  private:                                                                               \
    ...
    std::vector<NoteInfo> noteStack;                                                     \
                                                                                         \
    ExpSmoother16 smoothDelayTime;                                                       \
    ExpSmoother<float> smoothMasterGain;                                                 \
    ExpSmoother<float> smoothNoiseGain;                                                  \
    ExpSmoother<float> smoothPropagation;                                                \
                                                                                         \
    float gate = 0.0f;                                                                   \
    RingDelay<float> ringDelay;                                                          \
    NoiseAD<float> noiseOsc;                                                             \
    KsDelay<float, 8> ksDelay;                                                           \
  };
