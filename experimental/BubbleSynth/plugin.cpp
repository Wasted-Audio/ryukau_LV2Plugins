...
class BubbleSynth : public Plugin {
public:
  BubbleSynth() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  const char *getLabel() const override { return "BubbleSynth"; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(BubbleSynth)
};

Plugin *createPlugin() { return new BubbleSynth(); }
