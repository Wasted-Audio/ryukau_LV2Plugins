...
class NoiseTester : public Plugin {
public:
  NoiseTester() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  const char *getLabel() const override { return "NoiseTester"; }
  const char *getDescription() const override { return "Noise generator."; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(NoiseTester)
};

Plugin *createPlugin() { return new NoiseTester(); }
