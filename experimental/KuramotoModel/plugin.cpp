...
class KuramotoModel : public Plugin {
public:
  KuramotoModel() : Plugin(ParameterID::ID_ENUM_LENGTH, 0, 0)
  {
...
protected:
  const char *getLabel() const override { return "KuramotoModel"; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(KuramotoModel)
};

Plugin *createPlugin() { return new KuramotoModel(); }
