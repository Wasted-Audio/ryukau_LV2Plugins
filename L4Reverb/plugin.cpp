...
protected:
  /* Information */
  const char *getLabel() const override { return "L4Reverb"; }
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(L4Reverb)
};

Plugin *createPlugin() { return new L4Reverb(); }
